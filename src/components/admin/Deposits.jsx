    ...
    <>
      <div className="dashboardContainer">
        ...
        <div className="maincontent">
          <Body>
            <h4>
              <i className="fa fa-compass text-primary"></i> {location.pathname}
            </h4>
                  ...
                  <form action="" className="form-group" onSubmit={submitForm}>
                    <div className="row ml-md-5 mt-5">
                      <div className="col-md-4">
                        ...
                        <small className="text-muted">
                          This is the user identification character *.
                        </small>
                      </div>
                    ...
                    <div className="row ml-md-5 mt-5">
                      <div className="col-md-4">
                        ...
                        <small className="text-muted">
                          Select a package which payment falls into *.
                        </small>
                      </div>
                      <div className="col-md-7">
                        <div className="input-group mb-4">
                          <div className="input-group-prepend">
                            <span
                              ...
                              id="basic-addon1"
                            >
                              <i className="fa fa-gift text-white"></i>
                            </span>
                          </div>
                          <select
                            className="form-control"
                    ...
                    <div className="row ml-md-5 mt-5">
                      <div className="col-md-4">
                        ...
                        <small className="text-muted">
                          This the amount paid by the user *.
                        </small>
                      </div>
                      <div className="col-md-7">
                        <div className="input-group mb-4">
                          <div className="input-group-prepend">
                            <span
                              ...
                              id="basic-addon1"
                            >
                              <i className="fa fa-paypal text-white"></i>
                            </span>
                          </div>
                          <input
                            type="tel"
                    ...
                    {isloading ? (
                      <button className="btn btn-dark btn-sm  mt-5 mb-3 float-right">
                        <img
                          src={loading}
                      ...
                      <button
                        className="btn btn-dark btn-sm  mt-5 mb-3 float-right"
                        type="submit"
                      >
                        Deposit
                      </button>
                        ...
                        {deposits ? (
                          deposits.map((item, i) => (
                            <tr key={i}>
                              ...
                              <td>{item.status}</td>
                              <td>
                                <i className="fa fa-hourglass-half mr-1"></i>
                                {item.createdAt}
                              </td>
                            </tr>
                          ))
